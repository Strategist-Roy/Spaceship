...
public class PlayerController: MonoBehaviour
{
	...
	void Update () {
		...
		transform.position = new Vector3 (Mathf.Clamp (transform.position.x, -43.19F, -38F), 10, Mathf.Clamp (transform.position.z, -17F, 20F));    //Prevents Ship from exiting screen by clamping the position
